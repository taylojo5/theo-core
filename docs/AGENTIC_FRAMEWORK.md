...
// Special queries
async function getAssumptionsForAction(actionId: string): Promise<AuditAssumption[]>;
async function getActionChain(startActionId: string): Promise<AuditEntry[]>;
async function getUnverifiedAssumptions(userId: string): Promise<AuditAssumption[]>;
```
