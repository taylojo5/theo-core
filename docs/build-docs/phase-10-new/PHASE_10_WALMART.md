...
{
  "stepLogs": [
    { "step": 1, "action": "navigate", "url": "https://walmart.com/ip/...", "success": true },
    { "step": 2, "action": "click", "selector": "[data-automation-id='add-to-cart']", "success": true },
    { "step": 3, "action": "wait", "condition": "cart-updated", "success": true }
  ],
  "screenshots": [],
